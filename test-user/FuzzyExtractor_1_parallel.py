...
def istto(test):
    ...
    for i in range(1,421):
        os.chdir(r"C:\Users\MSI\OneDrive - Trường ĐH CNTT - University of Information Technology\Máy tính\New folder (2)\kpca_vec\training")
...
if __name__ == '__main__':
    ...
    Kwindow = 128
    G_vecs=[]
    os.chdir(r"C:\Users\MSI\OneDrive - Trường ĐH CNTT - University of Information Technology\Máy tính\test-otp")
